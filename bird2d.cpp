...
namespace BIRD2D
{
 ...
 namespace Graphics
 {
  ...
  bool Screen::check_horizontal_border(const unsigned int x,const unsigned int width) const
  {
   return (x+width)>=this->get_width();
  }

  bool Screen::check_vertical_border(const unsigned int y,const unsigned int height) const
  {
   return (y+height)>=this->get_height();
  }
  ...
  bool Camera::check_vertical_border(const BIRD2D::BOX target) const
  {
  ...
  bool Background::load(Image *background,const BIRD2D::IMAGE_KIND kind,const unsigned int frames)
  {
  ...
  bool Background::load(const char *name,const BIRD2D::IMAGE_KIND kind,const unsigned int frames)
  {
