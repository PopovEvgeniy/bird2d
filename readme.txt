...
Bird 2d is an ultra-fast 2D game engine for Linux. It uses OPENGL for render.

License

Bird 2d distributed under Zlib license.

Features

 Minimum external dependencies: only Xlib, Mesa 3d, ALSA and Posix Threads.
